...
import KMarketFrames.AdministratorProfile;
import KMarketFrames.EmployeeProfile;
...
public class Frame1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("New user ? .. Create a new account ?");
...
}else{ jToggleButton2.setBackground(Color.white);
jLabel6.setText("");
}
...
}else{ jToggleButton1.setBackground(Color.white);
jLabel6.setText("");
}
...
if (jToggleButton1.isSelected()) {
            ...
            if (obj.isExist("Adminstrator", jTextField1.getText(), password)) {
                ...
                AdministratorProfile.main(new String[0]);
                this.dispose();
            } else {
            ...
            if (obj.isExist("Employee", jTextField1.getText(), password)) {
                ...
                EmployeeProfile f = new EmployeeProfile();
                f.setVisible(true);
